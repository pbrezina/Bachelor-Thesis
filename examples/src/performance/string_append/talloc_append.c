...
static char* test_talloc_filter(TALLOC_CTX *mem_ctx, char **groups, int count)
{
    char *str = NULL;
    int i;
...
static char* test_talloc_filter_exact_pool(TALLOC_CTX *mem_ctx, char **groups, int count)
{
...
static char* test_talloc_filter_guess_pool(TALLOC_CTX *mem_ctx, char **groups, int count)
{
    TALLOC_CTX *pool_ctx = NULL;
    size_t len_total = 0;
    char *str = NULL;
...
static char* test_talloc_filter_parent_pool(TALLOC_CTX *mem_ctx, char **groups, int count)
{
    char *str = NULL;
    int i;
...
void test_talloc_append(int count, const char *str)
{
    ...
    filter = test_talloc_filter(tmp_ctx, groups, count);
...
void test_talloc_append_exact_pool(int count, const char *str)
{
    ...
    filter = test_talloc_filter_exact_pool(tmp_ctx, groups, count);
    ENOMEMCHECK(filter, done);
...
void test_talloc_append_guess_pool(int count, const char *str)
{
    ...
    filter = test_talloc_filter_guess_pool(tmp_ctx, groups, count);
    ENOMEMCHECK(filter, done);
...
void test_talloc_append_parent_exact_pool(int count, const char *str)
{
    ...
    filter = test_talloc_filter_parent_pool(pool_ctx, groups, count);
    ENOMEMCHECK(filter, done);
