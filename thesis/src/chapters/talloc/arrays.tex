...
|talloc_array_length(ctx)| that serves for this purpose. It requires the name
embedded within the context to be the name of the data type. Thus if we want to
use this feature, we should use the type-safe functions to create the array.
