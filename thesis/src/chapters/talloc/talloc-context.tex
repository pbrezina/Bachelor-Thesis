...
programs can contain thousands of calls of |malloc()| for a single user request.
...
an initialization of a new pool context using |talloc_pool()|\footnotemark. Such
context can be used in the same way as any other context.
