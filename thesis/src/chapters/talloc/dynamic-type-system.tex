...
Unfortunately, as a result of this type cast we are loosing the type
information. The compiler can not check the type during the compilation nor we
are able to do it during the runtime. Providing an invalid data type to the
