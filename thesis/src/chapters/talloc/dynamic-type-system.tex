...
nor templates known from object oriented languages, neither the dynamic type
system. Therefore, generic programming in this language is usually done by type
casting a variable to |void*| and transfer it through a generic function to a
specialized callback as illustrated on the next listing.
